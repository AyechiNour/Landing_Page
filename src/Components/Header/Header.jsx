      ...
      <div className="grid lg:grid-cols-2 flex items-center relative xl:pb-16 mt-16 xl:mt-0">
        <div className="order-2 lg:order-1 lg:col-span-1 px-4 lg:p-16 flex flex-col z-30 justify-center items-center lg:items-start">
          <div className="flex flex-row py-3 md:py-5">
            ...
            <h1 className="px-4 text-4xl xl:text-6xl 2xl:text-8xl uppercase  relative" style={{ fontFamily: 'Loew-light', top: "0.64px" }}>{t('HeaderTitle1Part2')}</h1>
          </div>
        ...
        <div className="order-1 lg:order-2 p-4 lg:p-10 z-30 lg:col-span-1 relative">
          <div className="z-30 flex justify-center w-full relative h-full items-center">
            <img src="./Images/animationmob.gif" className=" absolute lg:hidden -top-10 flex h-full w-full" alt="" />
            <img className="z-30" src="/Images/thumb.png" alt="" srcset="" />
          </div>
        </div>
      </div>
    </div>
