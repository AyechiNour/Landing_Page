...
const Header = () => {
  return (
    <div className="grid lg:grid-cols-2 flex items-center  my-10">
        <div className="lg:col-span-1 p-4 lg:p-16 flex flex-col z-30 justify-center items-center lg:items-start">
          ...
          <div>
            <input className="mr-4 font-medium text-sm h-10 w-28 lg:text-xl lg:h-14 lg:w-48 rounded-full btnEffet cursor-pointer" type="button" value="More info"/>
            <input className="font-medium text-sm h-10 w-28 lg:text-xl lg:h-14 lg:w-48 rounded-full btnEffet cursor-pointer"  type="button" value="Discord"/>
          </div>
        </div>
        <div className="p-4 lg:p-10 z-30 lg:col-span-1 relative">
