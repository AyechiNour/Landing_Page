...
const CardNoImage = React.memo(({ data }) => {
        ...
        <motion.div
            ...
            <div className="xl:hidden">
                ...
                <div className="flex flex-col justify-center items-center relative mt-10">
                    <svg className="absolute lg:hidden block -top-8 z-0" style={{ left: "20px" }} xmlns="http://www.w3.org/2000/svg" width="5" height="703.5" viewBox="0 0 5 703.5">
            ...
            <div className="xl:flex hidden flex-col relative w-full mb-28 sm:px-2 md:mt-48 lg:mt-0 relative left-0.5">
                ...
                <div className="flex flex-row lg:relative lg:left-28 py-10 lg:px-10 px-2 sm:ml-0 ml-2 mt-6" style={{ width: "96%", backgroundColor: "#6103618c" }}>
                    <svg className="absolute lg:block hidden -top-5" style={{ left: "-91px" }} xmlns="http://www.w3.org/2000/svg" width="5" height="150%" viewBox="0 0 5 466.568">
                    ...
                    <img src={data.img} className="lg:w-60 ml-16 absolute xl:-top-36 lg:-top-16 sm:-top-32 md:-top-40 -top-20 z-40 img0 cursor-pointer xl:right-16 lg:right-6 lg:ml-0 ml-5" alt="" />
                    <img src={data.effet} className="lg:w-60 ml-16 absolute xl:-top-36 lg:-top-28 sm:-top-24 -top-20 z-30 img1 xl:right-16 lg:right-6 lg:ml-0 ml-5" alt="" />
