...
const CardPlatform = ({ info }) => {
  ...
  console.log(info)
  return (
    <div onClick={() => { setapparence(!apparence) }} className='cursor-pointer p-4 z-40 lg:p-6 bg-cardplatform rounded-3xl my-4'>
      ...
      <div className={apparence ? 'block' : 'hidden'}>
        <p className='z-40 text-lg 2xl:text-2xl py-2'>{info.paragraph}</p>
        <div className={info.prize1 ? 'pl-4' : 'hidden'}>
          <li className='z-40 text-lg 2xl:text-2xl'>{info.prize1}</li>
          <li className='z-40 text-lg 2xl:text-2xl'>{info.prize2}</li>
          <li className='z-40 text-lg 2xl:text-2xl'>{info.prize3}</li>
          <li className='z-40 text-lg 2xl:text-2xl'>{info.prize4}</li>
        </div>
        <p className={info.paragraph1 ? 'z-40 text-lg 2xl:text-2xl py-2' : 'hidden'}>{info.paragraph1}</p>
        <p className={info.paragraph2 ? 'z-40 text-lg 2xl:text-2xl py-2' : 'hidden'}>{info.paragraph2}</p>
      </div>
    </div>
  )
}
